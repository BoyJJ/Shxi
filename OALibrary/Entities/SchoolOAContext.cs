...
{
    public partial class SchoolOAContext : DbContext
    {
        public SchoolOAContext()
        {
        }

        public SchoolOAContext(DbContextOptions<SchoolOAContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<Plandistribute> Plandistribute { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=rm-uf6052662m189321aio.mysql.rds.aliyuncs.com;UserId=shiyujing;Password=Shiyujing123;Database=oa");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Plandistribute>(entity =>
            {
                entity.ToTable("plandistribute");
            ...
            modelBuilder.Entity<Plantable>(entity =>
            {
                ...
                entity.HasOne(d => d.Teacher)
                    .WithMany(p => p.Plantable)
                    .HasForeignKey(d => d.Teacherid)
                    .HasConstraintName("pttid");
            });
